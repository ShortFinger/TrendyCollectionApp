    ...
    >
      ...
      <view class="card-list">
        <template v-if="cards.length">
          <view v-for="(item, index) in cards" :key="item.id" class="card" @click="handleCardClick(index, item)">
            <view class="card-cover">
              <view class="card-image"
                :style="{ backgroundImage: item.squareThumb ? `url(${item.squareThumb})` : '' }" />
              <view class="card-corner-marks">
                <image v-if="item.lowerLeftCornerMark" class="card-corner card-corner-tl"
                  :src="item.lowerLeftCornerMark" mode="aspectFit" />
                <image v-if="item.upperLeftCornerMark" class="card-corner card-corner-tl"
                  :src="item.upperLeftCornerMark" mode="aspectFit" />
                <image v-if="item.lowerRightCornerMark" class="card-corner card-corner-br"
                  :src="item.lowerRightCornerMark" mode="aspectFit" />
              </view>
            </view>
